package com.bitmakers.firstjobs.jsonparser;

import android.content.Context;
import android.content.SharedPreferences;

import com.bitmakers.firstjobs.model_class.CityList;
import com.bitmakers.firstjobs.model_class.CompanyInfo;
import com.bitmakers.firstjobs.model_class.DistList;
    ...
    public String parseSignIn(String json, Context ctx){
        ...
        try {
            ...
            if(status.equals("Success"))
            {
                ...
                SharedPreferences pref = ctx.getSharedPreferences("FirstJob_Login", 0); // 0 - for private mode
